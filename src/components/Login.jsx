...
const Login = ()=> {
  ...
  return (
    <div className="grid grid-cols-2">
        <div>
       <img src={Logo} className="w-[40rem] object-cover" alt="logo" />
       </div>
       <div>
            ...
            <form>
                ...
                <div className="mb-5">
                    <Link to={"/"} className="flex items-center gap-2">
                        <button type="submit" className="w-[40rem] px-3 py-4 bg-orange-400 text-white rounded-lg focus:bg-orange-700 focus:outline-none" >Login</button>
                    </Link>
