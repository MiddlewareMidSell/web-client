  ...
  return (
    <div className="flex items-center w-full min-h-screen">
        ...
        <div className="flex justify-center mr-10">
            ...
            <div className="flex flex-col ">
                <div className="flex flex-row justify-between w-[30rem] mb-3">
                    ...
                    <h5 className="text-xl text-stone-900">Nuwan Gamage</h5>   
                </div>

                <div className="flex flex-row justify-between w-[30rem]">
                    <h6 className="text-sm text-Stone-900">Deliver Date : 2022/11/02</h6>
                    <h6 className="text-sm text-Stone-900 text-bold">Mobile: 0711745533</h6>   
                </div>
        ...
        <div className="flex justify-center">
            ...
            <div className="flex flex-col ">
                <div className="flex flex-row justify-between w-[30rem] mb-3">
                    <h5 className="text-2xl font-bold text-red-400">Order ID : 02</h5>
                    <h5 className="text-xl text-stone-900">Gihan Samaraweera</h5>   
                </div>

                <div className="flex flex-row justify-between w-[30rem]">
                    <h6 className="text-sm text-Stone-900">Deliver Date : 2022/11/25</h6>
            ...
            <div>
                <div className="flex flex-row justify-between mt-5">
                    <div>
                        < img src="./img/cookies.jpg" height={150} width={100}></img>
                    </div>
                    <div className="flex flex-col justify-around text-right">
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">Cookies</span> : Item</h5>
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">10</span> : Quantity</h5> 
                    </div>
                </div>
                <div className="h-0.5 mt-3 bg-slate-400 " ></div>
            ...
            <div>
                <div className="flex flex-row justify-between mt-5">
                    ...
                    <div className="flex flex-col justify-around text-right">
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">Oragen Cup Cake</span> : Item</h5>
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">02</span> : Quantity</h5> 
                    </div>
                </div>
                <div className="h-0.5 mt-3 bg-slate-400 " ></div>
            </div>
            ...
            <div>
                <div className="flex flex-row justify-between mt-5">
                    <div>
                        < img src="./img/wedding_cake.jpg" height={150} width={100}></img>
                    </div>
                    <div className="flex flex-col justify-around text-right">
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">Sweets Cake</span> : Item</h5>
                        <h5 className="text-base text-stone-500"><span className="text-stone-900">01</span> : Quantity</h5> 
                    </div>
                </div>
                <div className="h-0.5 mt-3 bg-slate-400 " ></div>
